...
- Автозапуска тестов *(позже опишу)*
...
- В IDE от JetBrains аналогичные штуки делать через [File Watchers](https://www.jetbrains.com/help/idea/using-file-watchers.html#ws_file_watchers_before_you_start)
