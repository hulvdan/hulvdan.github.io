# ⭐ Сокрытие кода. Топовый folding. VSCode Расширение Explicit Folding
...
3. Повысить лимит размера файла перед тем, когда сочтем, что его пора разбивать на более мелкие, специализированные
...
- Вкину пару мыслей:
  ...
  - Jonathan Blow отмечал что-то вроде: *«Когда ты extract-ишь функцию из другой, ты не упрощаешь код»*

  - Кармак отмечал ([John Carmack on Inlined Code](http://number-none.com/blow/blog/programming/2014/09/26/carmack-on-inlined-code.html)): *«If a function is only called from a single place, consider inlining it»*
